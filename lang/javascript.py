...
context.keymap(
    {
        "state const [<dgndictation>]": ["const ", text],
        "state let [<dgndictation>]": ["let ", text],
        "state variable [<dgndictation>]": ["var ", text],
        "state static [<dgndictation>]": ["static ", text],
        "args": ["()", Key("left")],
        "index": ["[]", Key("left")],
        ...
        "tools tag react": ["< />", Key("left left left")],
