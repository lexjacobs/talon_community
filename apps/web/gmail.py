...
ctx.keymap(
    {
        ...
        "tools bold": Key("cmd-b"),
        "tools italic": Key("cmd-i"),
        "underline": Key("cmd-u"),
        "numbered list": Key("cmd-shift-7"),
        "bulleted list": Key("cmd-shift-8"),
        "tools quote": Key("cmd-shift-9"),
        ...
        "toggle star": send_key_to_page("s"),
        "archive": send_key_to_page("e"),
        "tools mute": send_key_to_page("m"),
        ...
        "tools snooze": send_key_to_page("b"),
