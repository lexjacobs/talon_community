...
context.keymap(
    {
        ...
        "focus earl": focus_address_bar,
        "copy earl": Key("escape y y"),
        "go back": back,
        "go forth": forward,
        # "reload": Key("cmd-r"),
        "tab reset": Key("cmd-r"),
        # "hard reload": Key("cmd-shift-r"),
        "tab reset hard": Key("cmd-shift-r"),
        # "new tab": Key("cmd-t"),
        "tab new": Key("cmd-t"),
        # "close tab": Key("cmd-w"),
        "tab close": Key("cmd-w"),
        ...
        "tools develop": open_focus_devtools,
        # Clipboard
        # "cut": Key("cmd-x"),
        # "copy": Key("cmd-c"),
        # "paste": Key("cmd-v"),
        "tools paste": Key("cmd-alt-shift-v"),
        ...
        "tab move left": Key("ctrl-shift-left"),
        "tab move right": Key("ctrl-shift-right"),
    }
)
